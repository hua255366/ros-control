...
# 抓取坐标
#angles_grab = [(map_choice * 92),   -34.27, -2.46, 34.54, -4.3, -41.39]
angles_grab = [(map_choice * 94),  -30.67, -6.24, 32.16, -6.67, -42.18]
...
angles_putcar =  [-0.08, 11.07, -149.5, 61.96, 13.79, -44.73]
...
# zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx
    ...
    def map_choice_of_positions(self, i):
        ...
        positions_blue_right = [(1.778, 0.287,0.150)]# 7: middle_Obstacle_Right_Side
...
if __name__ == "__main__":
    try:
        ...
        print('ready to task3')
        time.sleep(0.5)
        m_speed.rotate_to_left(3.33, 0.505)
        move_forward.sonor_start_movement()
        m_speed.rotate_to_right(3.33, 0.463)
        time.sleep(0.3)
        m_speed.moveback(0.10, 0.2)
