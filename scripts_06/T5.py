...
# 抓取坐标
angles_grab = [(map_choice * 85),  -30.67, -6.24, 32.16, -6.67, -42.18]
#angles_grab = [80.06, -15.64, -32.95, 48.16, 7.29, -40.51]
...
# zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx zqx
    ...
    def map_choice_of_positions(self, i):
        ...
        positions_blue_right = [(-0.587, 0.265,3.090)]
...
# 抬起机械臂复位
        ...
        if self.execution_count >= 4 or time.time() - self.start_time > 420: # 480秒等待时间
            ...
            time.sleep(1)
            m_speed.rotate_to_left(3.33,0.48)
            time.sleep(0.8)
            m_speed.moveforward(5.7,0.4)
...
if __name__ == "__main__":
    try:
        ...
        m_speed.moveforward(3.5,0.4)
        print('ready to task3')
        time.sleep(1)
        m_speed.rotate_to_left(3.33, 0.515)
        move_forward.sonor_start_movement()
        m_speed.rotate_to_right(3.33, 0.4643)
        time.sleep(0.3)
