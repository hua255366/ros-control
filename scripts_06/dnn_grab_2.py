...
class Detect_marker(object):
    ...
    def obj_detect(self, img):
        ...
        #blob = cv2.dnn.blobFromImage(img, 1 / 255.0,(grabParams.IMG_SIZE,grabParams.IMG_SIZE),[0,0,0],swapRB=Ture,crop=False)
        net.setInput(blob)
        ...
        if boxes is not None:
            ...
            #self.yolo.draw_single(img,boxs,scores,classes)
