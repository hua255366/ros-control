...
# 第一次
   ...
   # 机械臂初始化     
    ...
    move.rotate_to_right(0.55, 2.9)
    time.sleep(1)
    move.rotate_to_right(0.55, 2.8)  #旋转两个90度，即180度,车头对墙，方便后面测距
   #调整前后距离
...
# # # 第二次
    ...
    for _ in range(4):  #10
        ...
        Sonor().sonor_control_goal_1()                      # 二次精调
    time.sleep(1)
    move.rotate_to_left(0.55, 2.7) # (0.55, 2.7)旋转90°      # 右转复位
    time.sleep(1)
...
# # # 第四次
    ...
    move.moveback(0.08, 3.5)   #后退到合适距离
