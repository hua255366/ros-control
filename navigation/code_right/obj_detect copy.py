...
class Detect_marker(object):
    ...
    def init_mycobot(self):
        ...
        Rob_basic().move_to_my_coords(grabParams.coords_ready, 60, 2.5)
    ...
    def grab_move(self, x, y):
        ...
        Rob_basic().move_to_my_coords(coords_target, 20, 3.5)      
        Rob_basic().grap(True)
        coords_finish = grabParams.coords_finish
        Rob_basic().move_to_my_coords(coords_finish, 50, 1) 
        done = True
        print("Done")
