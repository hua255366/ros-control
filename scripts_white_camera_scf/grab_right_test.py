...
class Detect_marker(object):
    ...
    def move_high(self, x, y, dist):
        ...
        coords_target = [coords[0], coords[1]+20, coords[2]+60, coords[3], coords[4], coords[5]]
        basic.move_to_target_coords(coords_target, grabParams_zyt3.GRAB_MOVE_SPEED)
        time.sleep(3)
        # 移动到目标位置
        coords_target1 = [coords[0]+10, coords[1]-50, coords[2]+45, coords[3], coords[4], coords[5]]
    ...
    def init_mycobot(self): 
        basic.grap(False)      
        time.sleep(3)
        coords_height = [-50.7,-130.1,315.6, -85.45, 45.12, -173.88]       
        basic.move_to_target_coords(coords_height,30)
