...
#基本参数
	...
	IMG_SIZE = 640 # 尽量不要动 有未知bug还没解决128
  #IMG_SIZE = 640
	done = False
	usb_dev = "/dev/arm" 
	baudrate = 115200
	...
	# 仓库货架使用
	coords_right_high = [-50.7, -130.1, 285.6, -85.45, 45.12, -173.88] # 向右高初始状态
	# coords_right_low  = [-54.9, -140.4, 214.0, -90.25, 47.02, -175.88] # 向右低初始状态
	coords_right_low  = [-50.6, -122.3, 225.0, -110.39, 42.41, 169.96] # 向右低初始状态

	# 公共区使用
	coords_left_high  = [53.7, 112.0, 318.0, -85.93, 45.13, 7.59] # 向左高初始状态
	coords_left_low   = [53.7, 112.0, 220.0, -85.93, 45.13, 7.59] # 向左低初始状态

	# 充能站使用
	coords_under      = [51.8, 170.7, 240, -179.16, 11.07, -45.73] # 向下初始状态
	# coords_under      = [51.8, 170.7 + 40, 240 - 80, -179.16, 11.07, -45.73] # 向下初始状态
	coords_back   = [190, -30, 245, -175, 0, -134]
...
#需要调试的参数
	...
	bias_left_low_z = 50#50 	# 向左边夹取时 夹取前后的高度变化 高+低-
...
grabParams_zyt3 = GrabParams_zyt3()
