...
if __name__ == "__main__":
    ...
    #         # print(real_x, real_y) 
    #         angle_left = [43.59, -61.25, -5.62, -20.91, 2.37, 50.0]
    #         angle_right = [-25.4, -67.58, -5.44, -17.22, -2.1, 49.83]
    #         if (count %2 ==0):
    #             b = detect.result_class
    #         if (b in a )and detect.result_class==b:
    ...
    #             time.sleep(3)
    #             if count % 2 ==0:
    #                 detect.put_down(angle_right, 20)
    #                 count+=1
    #             if count %2 != 0:
    #                 detect.put_down(angle_left, 20)
    #                 count+=1
    #         if count == 4:
    #             break
    ...
    while cv2.waitKey(1) < 0 and not done:
        ...
        if detect_result is None:
            ...
            angle_left = [43.59, -61.25, -5.62, -20.91, 2.37, 50.0]
            angle_right = [-25.4, -67.58, -5.44, -17.22, -2.1, 49.83]
            current_class= detect.result_class
