...
class Detect_marker(object):
    ...
    def move_high(self, x, y, dist):
        ...
        coords_target = [coords[0]+17, coords[1]+20, coords[2]+60, coords[3], coords[4], coords[5]]
        basic.move_to_target_coords(coords_target, grabParams_zyt3.GRAB_MOVE_SPEED)
        time.sleep(1)
        # 移动到目标位置
        coords_target1 = [coords[0]+15, coords[1]-50, coords[2]+45, coords[3], coords[4], coords[5]]
    ...
    def move_back(self):
        ...
        # 放置
        time.sleep(3)
        coords_target_4 = [coords_back[0]+70,coords_back[1],coords_back[2]-90,coords_back[3],coords_back[4],coords_back[5]]
        ...
        self.mc.send_angles(angles,30)
        time.sleep(3)
        coords_height = grabParams_zyt3.coords_right_high
        basic.move_to_target_coords(coords_height,50)
    ...
    if msg.data == "nav_ck":
        ...
        if detect_result is None:
            ...
            if num < count:
                ...
                num = sum_x = sum_y = 0
            print("zhuaqu")
            detect.move_high(real_x + grabParams_zyt3.x_bias, real_y + grabParams_zyt3.y_bias, 0)
...
def main():
    for i in range(4):
        ...
        rospy.spin()
        # 前往充能站
        rospy.Subscriber('nav_cnz', String, CNZcallback)
        rospy.loginfo("ready to trige")
        rospy.spin()
        time.sleep(2)
    #     if i is not 4:
