...
class Detect_marker(object):
    ...
    def move_high(self, x, y, dist):
        ...
        time.sleep(1)
        # 移动到目标位置
        coords_target1 = [coords[0]+17, coords[1]-50, coords[2]+45, coords[3], coords[4], coords[5]]
        ...
        time.sleep(3)
        basic.move_to_target_coords(coords, grabParams_zyt3.GRAB_MOVE_SPEED)
...
def main(self):
    ...
    # read camera
    os.system("python /home/robuster/RoboCom/navigation/BackcangNavigation.py")
    time.sleep(40)
