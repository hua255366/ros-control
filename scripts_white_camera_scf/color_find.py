...
'''
color_dist = {
    # 'red': {'Lower': np.array([11, 115, 70]), 'Upper': np.array([40, 255, 245])},
#               # 'blue': {'Lower': np.array([100, 80, 46]), 'Upper': np.array([124, 255, 255])},
#               # 'blue':{'Lower': np.array([100,43,46]),'Upper': np.array([124,255,255])},
#               'blue':{'Lower': np.array([90,43,46]),'Upper': np.array([110,255,255])},
...
#               'purple': {"Lower": np.array([123, 43, 46]), "Upper":np.array([138, 255, 255])},
