'''
project:The initial point of task 1 is on the right
version:1-1
author:jiayu
date:2024.6.26
'''
    ...
    while True:
        ...
        for contour_red in contours_red:
            ...
            if area_red > 5000 and area_red < 15000:
                ...
                if (x_red > 210 and x_red < 270) and (y_red > 130 and y_red < 185):
                    flag = 1
        # yellow
        for contour_yellow in contours_yellow:
            ...
            if area_yellow > 5000 and area_yellow < 15000:
                ...
                if (x_yellow > 210 and x_yellow < 270) and (y_yellow > 130 and y_yellow < 185):
                    flag = 1
        # blue
        for contour_blue in contours_blue:
            ...
            if area_blue > 5000 and area_blue < 15000:
                ...
                if (x_blue > 210 and x_blue < 270) and (y_blue > 130 and y_blue < 185):
                    flag = 1
        # green
        for contour_green in contours_green:
            ...
            if area_green > 5000 and area_green < 15000:
                ...
                if (x_green > 210 and x_green < 270) and (y_green > 130 and y_green < 185):
                    flag = 1
        # purple
        for contour_purple in contours_purple:
            ...
            if area_purple > 5000 and area_purple < 15000:
                ...
                if (x_purple > 210 and x_purple < 270) and (y_purple > 130 and y_purple < 185):
                    flag = 1
        # orange
        for contour_orange in contours_orange:
            ...
            if area_orange > 5000 and area_orange < 15000:
                ...
                if (x_orange > 210 and x_orange < 270) and (y_orange > 130 and y_orange < 185):
                    flag = 1
