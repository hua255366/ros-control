    ...
    def _aging_test(self):
        ...
        aging_test_content_py = textwrap.dedent(
            ...
            def aging_test():
                ...
                mycobot.wait(3).send_angles([-170, -87.01, 99.84, -66.44, 2.63, 13.09], 95)
                mycobot.wait(3).send_angles([170, -87.01, 99.84, -66.44, 2.63, 13.09], 95)
                mycobot.wait(3).send_angles([0, 0, 0, 0, 0, 0], 95)

                mycobot.wait(3).send_angles([0, 0, 0, 0, 0, 0], 95)
                mycobot.wait(3).send_angles([-10.19, -55.01, -53.34, 14.67, 13.18, 12.83], 95)
                mycobot.wait(3).send_angles([-170.19, -55.01, -53.34, 14.67, 13.18, 12.83], 95)
                mycobot.wait(3).send_angles([170.19, -55.01, -53.34, 14.67, 13.18, 12.83], 95)
                mycobot.wait(3).send_angles([0, 0, 0, 0, 0, 0], 95)
                ...
                mycobot.wait(3).send_angles([141.76, -90.7, 125.06, -113.9, -40.6, 0.08], 55)
                mycobot.wait(3).send_angles([87.53, 19.95, -137.1, 91.14, 1.4, -6.15], 55)
                ...
                mycobot.wait(3).send_angles([-170, -87.01, 99.84, -66.44, 2.63, 13.09], 15)
                mycobot.wait(3).send_angles([170, -87.01, 99.84, -66.44, 2.63, 13.09], 15)
                mycobot.wait(3).send_angles([0, 0, 0, 0, 0, 0], 15)

                mycobot.wait(3).send_angles([-10.19, -55.01, -53.34, 14.67, 13.18, 12.83], 15)
                mycobot.wait(3).send_angles([-170.19, -55.01, -53.34, 14.67, 13.18, 12.83], 15)
                mycobot.wait(3).send_angles([170.19, -55.01, -53.34, 14.67, 13.18, 12.83], 15)
                mycobot.wait(3).send_angles([0, 0, 0, 0, 0, 0], 15)
                ...
                mycobot.wait(3).send_angles([141.76, -90.7, 125.06, -113.9, -40.6, 0.08], 15)
                mycobot.wait(3).send_angles([87.53, 19.95, -137.1, 91.14, 1.4, -6.15], 15)
