...
class Detect_marker(object):
    ...
    def move(self, x, y):
        ...
        coords_target = [coords[0]+int(x)-10, coords[1]+int(y)+5, height_bias, coords[3], coords[4], coords[5]]
...
#-------------------------------------------------------------------------------------------------------------
    ...
    def run_put_down_left_1(self):
        ...
        angles_1_3 = [37.17, -89.38, 50, -15, 7.73, 33.39]      
...
while i<4:
    ...
    if detect_result is not None and  right==1 and class_detected== add1:
    ...
    if detect_result is not None and right==2 and class_detected!= add1  :
