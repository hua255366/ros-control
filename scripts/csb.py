...
while i < 4:
    ...
    if init_num == 0:
        ...
        if num1 == outcome1:
            ...
            # you2
            angles = [180, -41.31, -34.83, 10.42, -15.72, 66.7]
            mc.send_angles(angles, 40)
            time.sleep(2)
...
#######################################
moveforward1(10, 0.2)  # go1
time.sleep(1)

rotate_to_left1(0.75, 0.5)
time.sleep(2)

moveforward1(3, 0.2)  # go1
time.sleep(1)
