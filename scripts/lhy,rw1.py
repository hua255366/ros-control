...
while True:
    ...
    while True:
        ...
        for contour_red in contours_red:
            ...
            if area_red > 5000 and area_red < 15000:
                ...
                if (x_red > 300 and x_red < 450) and (y_red > 120 and y_red < 200):
                    flag = 1
        # yellow
        for contour_yellow in contours_yellow:
            ...
            if area_yellow > 3000 and area_yellow < 20000:
                ...
                if (x_yellow > 300 and x_yellow < 450) and (y_yellow >140 and y_yellow < 200):
                    flag = 1
        # blue
        for contour_blue in contours_blue:
            ...
            if area_blue > 5000 and area_blue < 15000:
                ...
                if (x_blue > 300 and x_blue < 450) and (y_blue > 190 and y_blue < 200):
                    flag = 1
        # green
    ...
    angles = [-90.35, 4.58, -65.67, 68.93, 5.97, -46.79]
    ...
    angles = [-88.59, -39.21, -91.96, 58.21, -6.82, -44.03]
    #mc.send_angles(angles, 65)
    time.sleep(1)
    ...
    angles = [-90.26, 70.68, -134.65, 65.33, 5.27, -46.58]
    mc.send_angles(angles, 65)
    time.sleep(1)
