...
class Detect_marker(object):
    ...
    def move(self, x, y):
        ...
        coords_target = [coords[0]+int(x)+3, coords[1]+int(y)+5, height_bias, coords[3], coords[4], coords[5]]
        coords_target2 = [coords[0]+int(x)+4, coords[1]+int(y)-10, height_bias-100, coords[3], coords[4], coords[5]]
    ...
    def obj_detect(self, img):
        ...
        if x+y > 0:
            ...
            return x, y,detected_class,scores[0]
...
#-------------------------------------------------------------------------------------------------------------
    ...
    def run_put_down_left_2(self):
        ...
        angles_1_2 =[66.5,-24.87, -88.85, 29.17, -6.24, 48.16]
    ...
    def run_put_down_right_1(self):   
        ...
        angles_2_1 =[-17.4, -74.44, -3.07, -2.63, 0.96, 30.93]
    ...
    def run_put_down_right_2(self):   
        ...
        angles_2_2=[-27.94, -19.42, -103.18, 39.99, -6.76, 22.32]
...
while True:
    ...
    while True:        
        ...
        if detect_result is None:           
            ...
            x, y ,class_detected,confidence= detect_result
